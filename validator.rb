  ...
  task validator: :environment do
    ...
    class FaspexQuotaServlet < WEBrick::HTTPServlet::AbstractServlet
      def do_POST(request, response)
        ...
        response.body = { error: { code: 18,
                                   message: 'my long message here fdshgfkagdsfhjkasdgfhjkdgfhjadksfgdjsakfgdhsajkfgdjfkgasfjksdgahfjkdasgfjadsfdsgk' } }.to_json
      end
    end

    server = WEBrick::HTTPServer.new(Port: 12_345)
